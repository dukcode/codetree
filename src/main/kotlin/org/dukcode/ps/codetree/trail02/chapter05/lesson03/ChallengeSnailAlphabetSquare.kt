package org.dukcode.ps.codetree.trail02.chapter05.lesson03.challengeSnailAlphabetSquare
...
fun main() {
    ...
    repeat(h * w) {
        ...
        if (ny !in 0 until h || nx !in 0 until w || board[ny][nx] != '\u0000') {
            dir = (dir + 1) % 4
        }
