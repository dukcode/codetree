...
/**
 * @see <a
 * href="https://www.codetree.ai/ko/trails/complete/curated-cards/challenge-climbing-stairs/description">LINK</a>
 */
public class ChallengeClimbingStairs {
...
//    return solveTopDown(n, cache);
  ...
  private static int solveTopDown(int n, int[] cache) {
    ...
    return cache[n] = (solveTopDown(n - 2, cache) + solveTopDown(n - 3, cache)) % MOD;
  }
