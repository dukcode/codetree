...
/**
 * @see <a
 * href="https://www.codetree.ai/ko/trails/complete/curated-cards/challenge-square-made-of-two-points/description">LINK</a>
 */
public class ChallengeSquareMadeOfTwoPoints {
  ...
  public static void main(String[] args) throws IOException {
    ...
    int length = Math.max(y2 - y1, x2 - x1);
