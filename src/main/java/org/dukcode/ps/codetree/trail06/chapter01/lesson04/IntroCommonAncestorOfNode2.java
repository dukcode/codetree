...
/**
 * @see <a
 * href="https://www.codetree.ai/ko/trails/complete/curated-cards/intro-common-ancestor-of-node-2/description">LINK</a>
 */
public class IntroCommonAncestorOfNode2 {
  ...
  private static void dfs(int cur, int parent, int depthNow) {
    depths[cur] = depthNow;
