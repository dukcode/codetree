...
/**
 * @see <a
 * href="https://www.codetree.ai/ko/trails/complete/curated-cards/challenge-tree-path-length/description">LINK</a>
 */
public class ChallengeTreePathLength {
  ...
  private static int solve(int a, int b) {
    int c = lca(a, b);
    return 1 + depths[a] + depths[b] - 2 * depths[c];
  }
