...
/**
 * @see <a
 * href="https://www.codetree.ai/ko/trails/complete/curated-cards/challenge-common-ancestor-of-node-3/description">LINK</a>
 */
public class ChallengeCommonAncestorOfNode3 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    for (int i = 0; i < q; i++) {
      ...
      bw.write(String.valueOf(lca(a, b, c) + 1));
      bw.newLine();
    }
